...
<div class="row mt-4">
	<div class="col-md-4" style="margin-left:15%;float: none;">
		<div class="card">
			<div class="card-header bg-primary text-white">Edit Selected Transaction</div>
			<div class="card-body">
	...
	<div class="col-md-4" >
		<div class="card">
			<div class="card-header bg-warning">Add New Transaction in the Selected User</div>
			<div class="card-body">
